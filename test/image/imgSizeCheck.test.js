...
test('验证图片尺寸: 320x280', () => {
  ...
  validateImage('http://a/d/x-s/t/a/t/ic.k/s/os/o/f/t.com/upload/adx/5cbd716ae4b0f2cf91f2a047.png', option).then(res => {
...
test('验证图片尺寸: 320x280,返回 false', () => {
  ...
  validateImage('http://a/d/x-s/t/a/t/ic.k/s/os/o/f/t/upload/adx/5cbd716ae4b0f2cf91f2a047.png', option).then(res => {
    expect(res.data.result).toBe(false)
  })
})
...
test('验证图片尺寸(误差10): 320x280', () => {
  ...
  validateImage('http://a/d/x-s/t/a/t/ic.k/s/os/o/f/tcom/upload/adx/5cbd716ae4b0f2cf91f2a047.png', option).then(res => {
    expect(res.data.result).toBe(true)
  })
})
